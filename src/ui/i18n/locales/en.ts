export default {
  ...
  multiplierBreakdown: {
    ...
    electromagneticPowerGainNote: "This shows EP gained from one judge-line crossing. Crossing frequency, EP decay, and boundary penalties are separate and are not included here.",
    base: "Base input",
    ...
    entries: {
      ...
      "ep-power-gain-upgrade": "EP Production Upgrade",
      "ep-line-gain-upgrade": "Line-Crossing EP Upgrade",
      "coherence-ep-gain": "Coherence EP Upgrade",
    },
  },
  mainPage: {
  ...
  conceptCrystals: {
    ...
    togglePathTitle: "Click to sever or restore production from {from} to {to}",
    toggleInnerProductionTitle: "Click to freeze or restore {concept} production",
    innerFrozen: "Frozen",
    innerNetProduction: "Net {value}/turn",
    innerCycleLabel: "Cyclic suppression",
    ...
    effect: {
      ...
      copy: "The values below show how strongly each concept pushes or restrains its effect. Opposing concepts cancel each other; the results above show their actual combined influence. Holding more Concept Crystals amplifies these influences.",
      copyCrushTwo: "Consensus replaces Conquest, no longer suppresses CP gain, and independently raises Shielding Efficiency. The values below show each concept's influence; the results above show their actual combined effects.",
      copyCrushFour: "Freedom replaces Shackle, no longer worsens Assimilation, and independently weakens the first four DE Softcaps. The values below show each concept's influence; the results above show their actual combined effects.",
      copyCrushFive: "Faith, Justice, and Revolution form an inner cycle. Each is produced by its adjacent outer concepts and subtracts its amount from the next inner concept. Click an incoming production line to freeze or restore that inner concept.",
      copyCrushSix: "Peace replaces War, no longer worsens DC cost growth, and gently quickens the entire concept circuit. It reaches roughly ×3 speed near the current node limit and can continue growing beyond it.",
      dcCostGrowth: "Actual concept influence on post-20 DC cost growth: ×{value}",
      cpGain: "Actual concept influence on CP gain: ×{value}",
      assimilation: "Actual concept influence on Assimilation strength: ×{value}",
      shieldingEfficiency: "Shielding Efficiency provided by Consensus: ×{value}",
      softcapEfficiency: "First-four DE Softcap Efficiency provided by Freedom: ×{value}",
      conceptProductionSpeed: "Concept production speed provided by Peace: ×{value}",
      faith: "Faith raises every active Character bonus to the power of ^{value}",
      justice: "Justice slows Entropy growth by ÷{value}",
      revolution: "Revolution multiplies CE extraction by ×{value}",
      contributions: {
        hope: "Hope {amount}: strength of easing Assimilation {contribution}",
        conquest: "Conquest {amount}: strength of suppressing CP gain {contribution}",
        consensus: "Consensus {amount}: raises Shielding Efficiency to ×{contribution}",
        law: "Law {amount}: strength of restraining DC cost growth {contribution}",
        shackle: "Shackle {amount}: strength of worsening Assimilation {contribution}",
        freedom: "Freedom {amount}: raises the first four DE Softcap Efficiency to ×{contribution}",
        enlightenment: "Enlightenment {amount}: strength of promoting CP gain {contribution}",
        war: "War {amount}: strength of worsening DC cost growth {contribution}",
        peace: "Peace {amount}: raises concept production speed to ×{contribution}",
      },
    },
  },
  ...
  crushMilestones: {
    ...
    placeholderNote: "The global ×10 Dream Crystal bonus and the effects of Crush I through Crush VI are active. Later milestone effects remain placeholders.",
    ...
    items: {
      ...
      "4": {
        title: "Crush IV",
        effect: "Shackle becomes Freedom: it no longer worsens Assimilation and reduces the strength of the first four DE Softcaps based on its amount; Entropy grows ×10 faster in every stratum.",
      },
      "5": {
        title: "Crush V",
        effect: "Unlocks the inner concepts Faith, Justice, and Revolution with independently severable production, but Dream Crystals 3 and 4 cannot produce.",
      },
      "6": {
        title: "Crush VI",
        effect: "The Character system and every Character start unlocked. War becomes Peace: it no longer worsens DC cost growth and gradually raises concept production speed. Every stratum's effective chaos exponent is multiplied by 500.",
      },
      "7": {
        title: "Crush VII",
  ...
  crush: {
    ...
    dialog: {
      ...
      placeholderWarning: "Milestones are recorded normally. Crush I through Crush VI are active; the individual effects of later milestones remain placeholders.",
      cancel: "Cancel",
    },
  },
  realityMilestones: {
  ...
  currentStratum: {
    ...
    conceptConflict: {
      ...
      strengthMultiplier: "After Concept Conflict, current Dream Energy is {value} of the conflict boundary.",
    },
    shielding: {
      title: "Shielding",
