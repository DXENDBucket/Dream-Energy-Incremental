export default {
  ...
  multiplierBreakdown: {
    ...
    dreamCrystalTargetNote: "DC is not split into eight separate tiers; the final value uses DC1's complete output before conversion into Dream Energy.",
    base: "Base input",
  ...
  coherenceUpgrades: {
    ...
    items: {
      ...
      "coherence-upgrade-9": {
        title: "Force Release",
        description: "Multiply the second Dream Energy softcap strength by 0.99 each purchase.",
      },
