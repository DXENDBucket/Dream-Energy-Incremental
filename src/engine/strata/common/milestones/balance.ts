...
export const UNLOCK_ELECTROMAGNETIC_CRYSTALS_MILESTONE_ID = "unlock-electromagnetic-crystals";
...
export const UNLOCK_ELECTROMAGNETIC_CRYSTALS_REQUIREMENT = DREAM_ENERGY_CONCEPT_CONFLICT_START;
